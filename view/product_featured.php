                    ...
                    <div class="row row1 scroll-pane">
                      <div class="col col-4">
                        <label class="checkbox">
                          ...
                          <i></i>Rs 500 - Rs 700</label>
                      </div>
                      <div class="col col-4">
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                          <i></i>Rs 700 - Rs 1000</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 1000 - Rs 1500</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 1500 - Rs 2000</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 2000 - Rs 2500</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2" >
                        <i></i>Rs 2500 - Rs 3000</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 3500 - Rs 4000</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 4000 - Rs 4500</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 4500 - Rs 5000</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 5000 - Rs 5500</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 5500 - Rs 6000</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 6000 - Rs 6500</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 6500 - Rs 7000</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 7000 - Rs 7500</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 7500 - Rs 8000</label>
                        <label class="checkbox">
                          <input type="checkbox" name="checkbox2">
                        <i></i>Rs 8000 - Rs 8500</label>
                      </div>
                    </div>
                </section>
		       <section  class="sky-form">
