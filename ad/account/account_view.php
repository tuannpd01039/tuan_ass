...
<html lang="en"><head>
    ...
    <link rel="stylesheet" href="l../ib/font-awesome/css/font-awesome.css">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar navbar-default" role="navigation">
        <div class="navbar-header">
          ...
          <a class="" href="index.html"><span class="navbar-brand"><span class="fa fa-paper-plane"></span> Xixi - Boutique</span></a></div>
    ...
    <li><ul class="dashboard-menu nav nav-list collapse in">
            <li><a href="index.html"><span class="fa fa-caret-right"></span>Featured product</a></li>
            <li ><a href="users.html"><span class="fa fa-caret-right"></span> Sales product</a></li>
...
<div class="row">
    <div class="col-sm-6 col-md-6 " style="width:90%">
        <div class="panel panel-default">
            <div class="panel-heading no-collapse">Đơn hàng mới nhất<span class="label label-warning">+10</span></div>
              ...
              <?php $order=get_order();
			   ...
			   <td><?php echo $orders['email'];?></td>
	            ...
	            <td><?php echo number_format($orders['price']);?> VNĐ</td>
     			<td><a href="<?php echo $app_path;?>ad/account/?orderid=<?php echo $orders['orderID'];?>&act=del">ádasda</a></td>
